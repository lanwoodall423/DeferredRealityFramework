...
namespace DeferredReality.Simulation
{
    ...
    public static class RealityRepairPolicy
    {
        ...
        /// explicit update tick proves it newer; otherwise serialized order is authoritative.
        /// </summary>
        public static bool ShouldReplaceDuplicate(long? existingUpdateTick, long? candidateUpdateTick)
        {
